...
;(function($) {
	$.fn.scriptcam=function(options) {
		...
		return this.each(function() {
			...
			swfObj = "/Chamada/Application/View/swf/scriptcam.swf";
			...
			if (fileExists(decodeURIComponent(data.path)+swfObj)) {
				swfobject.embedSWF(decodeURIComponent(data.path)+swfObj, opts.id, newWidth, newHeight, '11.6', false, opts, params);
			}
			else {
